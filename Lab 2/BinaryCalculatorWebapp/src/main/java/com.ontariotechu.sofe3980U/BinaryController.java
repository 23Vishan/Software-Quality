...
public class BinaryController {
	...
	// displays 'view = calculator', if operand1 is given set value in first textbox and then focus on textbox 2
	@GetMapping("/")
	...
	// called by pressing the equal button, performs operation based on operand and operator
	@PostMapping("/")
